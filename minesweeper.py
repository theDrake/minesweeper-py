...
class Minesweeper():
    ...
    #              among three different size options. If Starts a new game if a new size
    #              is selected.
    #
    #      Inputs: widget - The widget object that sent the signal (a menu item,
    #                       in this case).
    ...
    #
    # Description: Displays a message as a dialog box with a single "OK" button.
    #
...
class MinesweeperButton(gtk.Button):
    ...
    #      Method: toggleFlag
    #
    # Description: Adds a flag image to the button, or removes the flag image if
